...
import block1.cc.antlr.Example;
...
public class ExampleTest {
    ...
    public void succeedingTest() {
        ...
        tester.yields("while while do",
                Example.WHILE, Example.WHILE, Example.DO);
    ...
    public void yieldCountTest() {
        tester.yields("do dodo",
                Example.DO, Example.DO, Example.DO);
    }

    @Test
    public void noSpacesBetweenKeywordsTest() {
        // the following is perfectly fine, so claiming it's wrong will fail
        tester.yields("whilewhiledodo",
                Example.WHILE, Example.WHILE, Example.DO, Example.DO);
    }
}
